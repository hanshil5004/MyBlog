<%-- 
    Document   : index
    Created on : Jul 28, 2022, 2:16:44 PM
    Author     : Parth
--%>
...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown"><a
                            class="nav-link dropdown-toggle font-size" href="#"
                            id="navbarDropdown" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><span class="fa fa-book mr-1"></span>Categories </a>
                ...
                <a href="login.jsp" class="btn btn-outline-info" type="button"><span
                        class="fa fa-user-circle mr-1"></span>Login</a>
            </div>
        </nav>
        <!-- End Navbar -->
        ...
        <!-- 	Start Sing Up Modal -->
        <!-- Modal -->
        <div class="modal fade" id="form-modal1" tabindex="-1" role="dialog"aria-labelledby="exampleModalLabel" aria-hidden="true">            
        ...
        <div class="container-fluid p-0 m-0">
            <div class="jumbotron primary-background">
                <div class="container">
                    ...
                    <p>My Blog  that an inscription uncovered at the Pyramid of Khentkaus I (pictured), identifies Khentkaus I as the mother of two kings, or perhaps the mother of one and a king herself?</p>
                    <button class="btn btn-outline-info" data-toggle="modal" data-target="#form-modal1"><span class="fa fa-edit mr-1"></span>Start ! its Free</button>
                    <a href="login.jsp" class="btn btn-outline-info"><span class="fa fa-user-circle fa-spin mr-1"></span> Login</a>
                </div>
            </div>
        </div>
        ...
        <script>
                                $(document).ready(function (e) {
                                    $("#singup_modal").on("submit", function (event) {
